...
const CATEGORY_POOL = {
  ...
  sport:      ['TENNIS','SOCCER','RUGBY','CRICKET','HOCKEY','BOXING','SKIING','SURFING','ROWING','CYCLING','SWIMMING','DIVING','ARCHERY','FENCING','WRESTLING','JUDO','GOLF','POLO','SQUASH','BADMINTON','VOLLEYBALL','BASKETBALL','BASEBALL','HANDBALL','CROQUET','DARTS','SNOOKER','CURLING','MARATHON','HURDLES','JAVELIN','DISCUS','TRIATHLON','BIATHLON','PENTATHLON','LACROSSE','NETBALL','SOFTBALL','BOWLING','KARATE','TAEKWONDO','SUMO','SAILING','CANOEING','CLIMBING','GYMNASTICS','WEIGHTLIFTING','SHOOTING','BOBSLED','LUGE','SKELETON','CROSSFIT','SKATEBOARDING','WAKEBOARDING'],
  ...
  occupation: ['DOCTOR','LAWYER','PILOT','CHEF','NURSE','JUDGE','BAKER','MINER','WELDER','TAILOR','FARMER','FISHER','HUNTER','ARCHER','SAILOR','TRADER','WRITER','ARTIST','SINGER','DANCER','ACTOR','COACH','GUARD','DRIVER','PORTER','RANGER','WARDEN','HERALD','SCRIBE','MASON','SMITH','COOPER','TANNER','WEAVER','MILLER','BREWER','POTTER','CARVER','GLAZIER','BARBER','BUTCHER','COBBLER','FARRIER','FLETCHER','THATCHER','CHANDLER','VINTNER','APOTHECARY'],
...
const GENERAL_WORDS = [
  ...
  'SLEET','SLEUTH','SLINK','SMOCK','SMUDGE','SNACK','SNAIL','SNOOP','SPIRE',
  'STAND','STARVE','STOUT','STRIFE','SWATH','THATCH','THICK',
  ...
  'CRYPT','CURED','CUTCH','DEPTH','DERBY','DINGO','DISCO','DITCH','DJINN',
  'DWARF','DYING','EJECT','EMERY','EPOCH','EVOKE','EXERT','EXTOL','EXULT',
  'FABLE','FACET','FAKER','FANCY','FARCE','FATWA','FAULT','FEAST','FENDS','FETID',
  'FIEND','FILCH','FINCH','FJORD','FLOUT','FORAY',
  'FRISK','FROTH','FUNGI','GAMUT','GAUZE','GAVEL','GAWKY','GELID','GERMS',
  ...
  'STOIC','STOKE','STONY','SNOUT','SNOWY','SMELT','SMOCK','SMOTE',
  'BRISK','BROOCH','GRUEL','GRIEVOUS','GRUBS','GUILT','GUSTO','INEPT',
